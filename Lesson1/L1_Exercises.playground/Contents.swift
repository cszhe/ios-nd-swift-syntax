...
let yourSentence = "The \(nounArray[index1]) and the \(nounArray[index2]) are friends"
...
for (k, v) in dictionary {
    newestString = newestString.replacingOccurrences(of: k, with: v)
}
print(newestString)
...
let numOfPennies = 78
//desired output = "$5.67"
let output = "$\(Double(numOfPennies) / 100.0)"
//: # Let or Var?
import UIKit
import Foundation
//: ### Exercise 9
