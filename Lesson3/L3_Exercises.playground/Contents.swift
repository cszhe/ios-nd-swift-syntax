...
var fiveBools = [true, false, false, true, true]
...
spaniels.insert("English Cocker", at: spaniels.index(of: "English Springer")!)
...
var di = ["Anchovies": true, "Coconut": true, "Cilantro": false, "Liver": false]
